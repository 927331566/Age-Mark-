...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        v1.tabBarItem.selectedImage = UIImage(named: "Home_副本4")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        v1.tabBarItem.imageInsets = UIEdgeInsets(top: 50, left: 30, bottom: 10, right: 20)
        v1.tabBarItem.image = UIImage(named: "Home_副本5")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        //v1.view.backgroundColor = UIColor.red
        //v1.title = "主页"
        let v2: SearchViewController = SearchViewController()
        v2.tabBarItem.selectedImage = UIImage(named: "Category_副本3")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        v2.tabBarItem.image = UIImage(named: "Category_副本2")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        v2.tabBarItem.imageInsets = UIEdgeInsets(top: 50, left: 30, bottom: 10, right: 20)
       ...
       // v2.view.backgroundColor = UIColor.blue
        ...
        //v3.tabBarItem.imageInsets = UIEdgeInsets(top: 50, left: 40, bottom: 20, right: 20)
        //v3.view.backgroundColor = UIColor.green
        //v3.title = "扫描"
        let v4: RoundViewController = RoundViewController()
        v4.tabBarItem.selectedImage = UIImage(named: "Chart_副本3")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        v4.tabBarItem.image = UIImage(named: "Chart_副本2")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        v4.tabBarItem.imageInsets = UIEdgeInsets(top: 50, left: 20, bottom: 10, right: 30)
